...
public class Screenshot {
	private static final String PATH_SCREENSHOT = GeradorDeRelatorio.PATH_REPORT + File.separator + "Screenshot";
    ...
    public static MediaEntityModelProvider capture(WebDriver driver) {
        ...
        try {
            ...
            String caminhoCapturaTela = PATH_SCREENSHOT + File.separator + "Imagem_" + ConfigurarData.pegarDataFormatadaCapturaTela() + ".png";
