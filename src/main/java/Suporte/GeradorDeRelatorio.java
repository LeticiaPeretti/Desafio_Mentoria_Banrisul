...
public class GeradorDeRelatorio {
    ...
    public static final String PATH_REPORT = System.getProperty("user.dir") + File.separator + "Report" + File.separator + "Report_" + ConfigurarData.getDateTimeFormatReport();
    ...
    public static void configReportExtent() {
        ...
        htmlReporter = new ExtentHtmlReporter(PATH_REPORT + File.separator + "MeuRelatorio_" + ConfigurarData.getDateTimeFormatReport() + ".html");
